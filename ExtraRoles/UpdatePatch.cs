    ...
    class HudUpdateManager
    {
        ...
        static void Postfix(HudManager __instance)
        {
            ...
            if (MedicSettings.Protected != null &&
                MedicSettings.Protected.PlayerId == PlayerControl.LocalPlayer.PlayerId &&
                __instance.UseButton.isActiveAndEnabled)
            {
                if (rend == null)
                {
                ...
                rend.transform.localPosition =
                    Camera.main.ScreenToWorldPoint(new Vector3(0 + (25 * scale), 0 + (25 * scale), -50f));
                rend.SetActive(true);
            }
            ...
            if (MedicSettings.Protected != null)
            {
                var showShielded = MedicSettings.showProtected;
                var canEveryoneSeeShield = showShielded == 3;
                if (canEveryoneSeeShield)
                {
                ...
                var canSeeShieldAsShieldedPlayer = PlayerControl.LocalPlayer == MedicSettings.Protected &&
                                                   (showShielded == 0 || showShielded == 2);
                if (canSeeShieldAsShieldedPlayer)
                {
                    MedicSettings.Protected.myRend.material.SetColor("_VisorColor", ModdedPalette.protectedColor);
                    MedicSettings.Protected.myRend.material.SetFloat("_Outline", 1f);
                    MedicSettings.Protected.myRend.material.SetColor("_OutlineColor", ModdedPalette.protectedColor);
                ...
                var canSeeShieldAsMedic = PlayerControl.LocalPlayer == MedicSettings.Medic &&
                                          (showShielded == 1 || showShielded == 2);
                if (canSeeShieldAsMedic)
                {
                    MedicSettings.Protected.myRend.material.SetColor("_VisorColor", ModdedPalette.protectedColor);
                    MedicSettings.Protected.myRend.material.SetFloat("_Outline", 1f);
                    MedicSettings.Protected.myRend.material.SetColor("_OutlineColor", ModdedPalette.protectedColor);
            ...
            if (MedicSettings.Medic != null && __instance.UseButton != null &&
                MedicSettings.Medic.PlayerId == PlayerControl.LocalPlayer.PlayerId &&
                __instance.UseButton.isActiveAndEnabled)
            {
            ...
            if (OfficerSettings.Officer == null || __instance.UseButton == null ||
                OfficerSettings.Officer.PlayerId != PlayerControl.LocalPlayer.PlayerId ||
                !__instance.UseButton.isActiveAndEnabled) 
                return;
